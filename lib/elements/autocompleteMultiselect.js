...
Filtered results for: ${this.inputValue ? this.inputValue : color.gray('Enter something to filter')}\n`;
  ...
  renderOption(cursor, v, i, arrowIndicator) {
    ...
    let title;
    if (v.disabled) title = cursor === i ? color.gray(color.underline(v.title)) : color.strikethrough(color.gray(v.title));
    else title = cursor === i ? color.cyan(color.underline(v.title)) : v.title;
    return prefix + title;
  }
